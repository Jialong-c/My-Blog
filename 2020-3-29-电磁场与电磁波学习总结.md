...
- 磁感应强度![](https://raw.githubusercontent.com/Jialong-c/images/master/Blog/3-29/磁感应强度.png)
...
- 磁矢位（由$ \nabla\cdot\nabla\times\vec{A}=0$）![](https://raw.githubusercontent.com/Jialong-c/images/master/Blog/3-29/磁矢位.png)
  $$
  \vec{\mathbf{B}}=\nabla\times\vec{\mathbf{A}}
  $$
